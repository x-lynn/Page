const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B_8uSU9x.js","assets/index-CIupnC83.css"])))=>i.map(i=>d[i]);
import{u as x,_ as l,a as f}from"./index-B_8uSU9x.js";function C(){const{createServiceClient:E,url:T}=f(),{loadConfig:p}=x(),S=async(r,i)=>{var n,a,e;try{const o=E(r),{data:s,error:t}=await o.rpc("exec_ddl",{sql_text:"SELECT 1;"});return t?(console.log("exec_ddl 函数检查错误:",t),t.code==="42883"||t.code==="P0001"||((n=t.message)==null?void 0:n.toLowerCase().includes("function"))||((a=t.message)==null?void 0:a.toLowerCase().includes("does not exist"))||((e=t.message)==null?void 0:e.toLowerCase().includes("不存在"))?(console.log("exec_ddl 函数不存在"),!1):(console.warn("exec_ddl 函数检查时出现其他错误:",t),!1)):(console.log("exec_ddl 函数存在，检查通过"),!0)}catch(o){return console.error("检查 exec_ddl 函数异常:",o),!1}},y=async(r="tableStatus")=>{const i=p();let n=(i==null?void 0:i.serviceKey)||"";if(!n){const e=document.getElementById("settingsServiceKey");e&&(n=e.value.trim(),r="settingsStatus")}if(!n){const{useStatus:e}=await l(async()=>{const{useStatus:s}=await import("./index-B_8uSU9x.js").then(t=>t.b);return{useStatus:s}},__vite__mapDeps([0,1])),{showStatus:o}=e(r);o("⚠️ 请先在设置页面填写 Service Role Key","warning");return}const a=T.value||(i==null?void 0:i.url)||"";if(!a){const{useStatus:e}=await l(async()=>{const{useStatus:s}=await import("./index-B_8uSU9x.js").then(t=>t.b);return{useStatus:s}},__vite__mapDeps([0,1])),{showStatus:o}=e(r);o("⚠️ 请先配置 Supabase URL 和 Service Role Key","error");return}try{if(!await S(n,a)){w(r,n,a);return}await m(n,a,r)}catch(e){console.error("创建任务表失败:",e);const{useStatus:o}=await l(async()=>{const{useStatus:t}=await import("./index-B_8uSU9x.js").then(c=>c.b);return{useStatus:t}},__vite__mapDeps([0,1])),{showStatus:s}=o(r);s(`❌ 创建任务表失败: ${e.message}`,"error")}},w=(r,i,n)=>{const a=`CREATE OR REPLACE FUNCTION exec_ddl(sql_text text)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
$$;`,e=document.getElementById(r);if(!e)return;const o="create-function-"+Date.now();e.innerHTML=`
    ...
    `,window.currentSQL=a,window.copySQL=async s=>{var d;const{copyToClipboard:t}=await l(async()=>{const{copyToClipboard:_}=await import("./index-B_8uSU9x.js").then(u=>u.b);return{copyToClipboard:_}},__vite__mapDeps([0,1])),c=window.currentSQL||((d=document.getElementById(s))==null?void 0:d.textContent);if(c&&await t(c)){const u=document.querySelector(`button[onclick*="${s}"]`);if(u){const g=u.textContent;u.textContent="✅ 已复制",u.style.background="#28a745",setTimeout(()=>{u.textContent=g,u.style.background=""},2e3)}}}},m=async(r,i,n)=>{const{useStatus:a}=await l(async()=>{const{useStatus:s}=await import("./index-B_8uSU9x.js").then(t=>t.b);return{useStatus:s}},__vite__mapDeps([0,1])),{showStatus:e}=a(n);e("⏳ 正在创建任务表...","info");const o=[`CREATE TABLE IF NOT EXISTS daily_tasks (
